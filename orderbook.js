...
import "./orderbook-flow-workspace.js?v=26-116-spot-tape-routing-v2";
...
const ORDERBOOK_WORKER_URL = new URL("./orderbook-worker.js?v=26-116-spot-tape-routing-v2", import.meta.url);
