...
import "./orderbook-flow-workspace.js?v=26-110-low-latency-active-tape-v1";
...
const ORDERBOOK_WORKER_URL = new URL("./orderbook-worker.js?v=26-110-low-latency-active-tape-v1", import.meta.url);
