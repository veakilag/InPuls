...
import "./orderbook-flow-workspace.js?v=26-51-signal-observation-engine-v1";
...
const ORDERBOOK_WORKER_URL = new URL("./orderbook-worker.js?v=26-51-signal-observation-engine-v1", import.meta.url);
...
const ORDERBOOK_RUNTIME_STYLE_ID = "inpuls-orderbook-runtime-26-51-signal-observation-engine-v1";
