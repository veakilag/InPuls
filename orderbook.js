...
import "./orderbook-flow-workspace.js?v=26-126-final-exchanges-v1";
import "./orderbook-events.js?v=orderbook-events-core-v1";
import "./orderbook-density.js?v=density-trades-correlation-v1";
import { normalizeOrderBookMarketKey } from "./orderbook-market-key.js?v=26-126-final-exchanges-v1";
import { ExchangeOrderBookFeed } from "./exchange-orderbook-feed.js?v=26-126-final-exchanges-v1";
import { normalizeExchange } from "./exchange-registry.js?v=26-126-final-exchanges-v1";
...
const ORDERBOOK_WORKER_URL = new URL("./orderbook-worker.js?v=26-126-final-exchanges-v1", import.meta.url);
