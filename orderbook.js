...
import "./orderbook-flow-workspace.js?v=26-125-aster-alpha-v1";
...
import { ExchangeOrderBookFeed } from "./exchange-orderbook-feed.js?v=26-125-aster-alpha-v1";
import { normalizeExchange } from "./exchange-registry.js?v=26-125-aster-alpha-v1";
...
const ORDERBOOK_WORKER_URL = new URL("./orderbook-worker.js?v=26-125-aster-alpha-v1", import.meta.url);
