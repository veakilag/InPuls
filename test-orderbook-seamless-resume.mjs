...
test("cache versions keep seamless resume while shipping Resume v2", () => {
  ...
  assert.match(serviceWorker, /orderbook\.js\?v=26-91-runtime-boot-cache-feed-v1/);
  assert.match(serviceWorker, /render-scheduler\.js\?v=render-scheduler-v1/);
  assert.match(serviceWorker, /orderbook-worker\.js\?v=26-91-runtime-boot-cache-feed-v1/);
