...
test("owner dashboard stays unlinked, local-only and exposes no destructive history controls", async () => {
  ...
  assert.match(worker, /owner-signal-lab-guard\.js\?v=26-58-signal-lab-review-export-v1/);
  assert.match(worker, /owner-signal-lab\.js\?v=26-58-signal-lab-review-export-v1/);
});
