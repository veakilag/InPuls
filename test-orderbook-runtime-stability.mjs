...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-77-tiger-zero-ms-agg-v1/);
  assert.match(app, /orderbook\.js\?v=26-77-tiger-zero-ms-agg-v1/);
  ...
  assert.match(orderbook, /orderbook-worker\.js\?v=26-77-tiger-zero-ms-agg-v1/);
  assert.match(sw, /inpuls-26-77-tiger-zero-ms-agg-v1/);
