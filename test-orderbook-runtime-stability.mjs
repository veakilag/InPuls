...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-123-chart-polish-v2/);
  assert.match(app, /orderbook\.js\?v=26-123-chart-polish-v2/);
  ...
  assert.match(orderbook, /orderbook-worker\.js\?v=26-123-chart-polish-v2/);
  assert.match(sw, /app\.js\?v=26-123-chart-polish-v2/);
  assert.match(sw, /orderbook\.js\?v=26-123-chart-polish-v2/);
  assert.match(sw, /orderbook-flow-workspace\.js\?v=26-123-chart-polish-v2/);
