...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-42-orderbook-scroll-theme-v1/);
  assert.match(app, /orderbook\.js\?v=26-42-orderbook-scroll-theme-v1/);
  ...
  assert.match(sw, /inpuls-26-42-orderbook-scroll-theme-v1/);
