...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(app, /orderbook\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(app, /render-scheduler\.js\?v=render-scheduler-v1/);
  assert.match(orderbook, /orderbook-flow-workspace\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(orderbook, /orderbook-worker\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(sw, /app\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(sw, /orderbook\.js\?v=26-110-low-latency-active-tape-v1/);
  assert.match(sw, /orderbook-flow-workspace\.js\?v=26-110-low-latency-active-tape-v1/);
