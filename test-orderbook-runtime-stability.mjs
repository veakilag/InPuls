...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-71-water-tape-v1/);
  ...
  assert.match(orderbook, /orderbook-worker\.js\?v=26-71-water-tape-v1/);
  assert.match(sw, /inpuls-26-71-water-tape-v1/);
