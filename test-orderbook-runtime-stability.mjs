...
test("normal reload keeps one consistent runtime build", () => {
  assert.match(index, /app\.js\?v=26-27-runtime-stability-v1/);
  assert.match(app, /orderbook\.js\?v=26-27-runtime-stability-v1/);
  ...
  assert.match(sw, /inpuls-26-27-runtime-stability-v1/);
  assert.match(reset, /Runtime Stability v1/);
