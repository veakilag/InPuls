...
test("Flow Workspace cache and reset page point to water runtime", () => {
  ...
  assert.match(serviceWorker, /app\.js\?v=26-117-chart-interaction-performance-v1/);
  assert.match(serviceWorker, /canvas-comfort-preview\.js\?v=26-117-chart-interaction-performance-v1/);
