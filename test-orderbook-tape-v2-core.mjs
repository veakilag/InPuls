...
test("Flow Workspace cache and reset page point to the new runtime", () => {
  assert.match(orderbook, /inpuls-orderbook-runtime-26-27-runtime-stability-v1/);
  assert.match(orderbook, /orderbook-flow-workspace\.js\?v=26-27-runtime-stability-v1/);
  ...
  assert.match(serviceWorker, /orderbook-tape-latency\.js\?v=26-27-runtime-stability-v1/);
  assert.match(serviceWorker, /orderbook-flow-workspace\.js\?v=26-27-runtime-stability-v1/);
  assert.match(resetPage, /Runtime Stability v1/);
  assert.match(resetPage, /sw\.js\?v=26-27-runtime-stability-v1/);
  assert.match(resetPage, /build=26-27-runtime-stability-v1/);
});
