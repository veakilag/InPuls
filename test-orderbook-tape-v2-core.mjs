...
test("Flow Workspace cache and reset page point to water runtime", () => {
  ...
  assert.match(serviceWorker, /app\.js\?v=26-104-tape-cluster-theme-clock-sync-v2/);
  assert.match(serviceWorker, /canvas-comfort-preview\.js\?v=26-104-tape-cluster-theme-clock-sync-v2/);
