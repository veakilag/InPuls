...
test("Flow Workspace cache and reset page point to water runtime", () => {
  ...
  assert.match(serviceWorker, /app\.js\?v=26-118-tape-cluster-market-key-v1/);
  assert.match(serviceWorker, /canvas-comfort-preview\.js\?v=26-118-tape-cluster-market-key-v1/);
