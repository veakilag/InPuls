...
test("Resume v2 ships one consistent runtime", () => {
  assert.match(index, /app\.js\?v=26-51-signal-observation-engine-v1/);
  assert.match(app, /orderbook\.js\?v=26-51-signal-observation-engine-v1/);
  ...
  assert.match(sw, /inpuls-26-51-signal-observation-engine-v1/);
