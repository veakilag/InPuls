...
const RELEASE_ASSETS = Object.freeze([
  ...
  "./app.js?v=26-104-tape-cluster-theme-clock-sync-v2",
  "./binance-clock-core.js?v=26-101-binance-clock-sync-v1",
  "./binance-clock.js?v=26-102-tape-live-edge-minute-boundary-v1",
  "./canvas-comfort-preview.js?v=26-104-tape-cluster-theme-clock-sync-v2",
  ...
  "./orderbook.js?v=26-104-tape-cluster-theme-clock-sync-v2",
  ...
  "./orderbook-flow-workspace.js?v=26-104-tape-cluster-theme-clock-sync-v2",
