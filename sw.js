const CACHE = "inpuls-26-78-agg-range-rx-v1";
const BUILD = "26-78-agg-range-rx-v1";

const FORCED = new Map([
  ["/app.js", "./app.js?v=26-78-agg-range-rx-v1"],
  ["/orderbook.js", "./orderbook.js?v=26-78-agg-range-rx-v1"],
  ...
  ["/pattern-catalog.js", "./pattern-catalog.js?v=26-78-agg-range-rx-v1"],
  ...
  ["/orderbook-worker.js", "./orderbook-worker.js?v=26-78-agg-range-rx-v1"],
...
const SHELL = [
  ...
  "./pattern-catalog.js?v=26-78-agg-range-rx-v1",
  ...
  "./orderbook-worker.js?v=26-78-agg-range-rx-v1",
  ...
  "./orderbook-flow-workspace.js?v=26-78-agg-range-rx-v1",
  "./observability.js?v=render-scheduler-v1",
  "./pwa-reset.js",
  "./refresh.html",
  "./refresh.js?v=26-78-agg-range-rx-v1",
  "./reset-v26.html",
  "./reset.js?v=26-78-agg-range-rx-v1",
