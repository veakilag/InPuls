...
const BUILD = "26-123-chart-polish-v2";
...
const RELEASE_ASSETS = Object.freeze([
  "./",
  "./index.html",
  "./styles.css?v=26-123-chart-polish-v2",
  "./workspace-v2.css?v=26-123-chart-polish-v2",
  "./app.js?v=26-123-chart-polish-v2",
  "./binance-stream-routing.js?v=26-123-chart-polish-v2",
  "./binance-clock-core.js?v=26-101-binance-clock-sync-v1",
  "./binance-clock.js?v=26-102-tape-live-edge-minute-boundary-v1",
  "./canvas-comfort-preview.js?v=26-123-chart-polish-v2",
  "./install-cta.js?v=26-123-chart-polish-v2",
  "./event-radar-beta.js?v=26-123-chart-polish-v2",
  "./event-radar-beta.css?v=26-123-chart-polish-v2",
  "./chart.js?v=26-123-chart-polish-v2",
  "./engine.js?v=26-123-chart-polish-v2",
  "./orderbook.js?v=26-123-chart-polish-v2",
  ...
  "./workspace-layout.js?v=26-123-chart-polish-v2",
  ...
  "./owner-signal-lab.css?v=26-123-chart-polish-v2",
  "./owner-signal-lab-v2.css?v=26-82-signal-lab-event-driven-collector-v1",
  "./owner-signal-lab-v3.html",
  "./owner-signal-lab-v3.js?v=26-123-chart-polish-v2",
  "./owner-signal-lab-v3.css?v=26-123-chart-polish-v2",
  ...
  "./orderbook-worker.js?v=26-123-chart-polish-v2",
  ...
  "./orderbook-flow-workspace.js?v=26-123-chart-polish-v2",
  "./orderbook-market-key.js?v=26-123-chart-polish-v2",
