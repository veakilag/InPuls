const CACHE = "inpuls-v26-20-runtime-hotfix";
...
const SHELL = [
  ...
  "./chart.js?v=23",
  "./engine.js?v=23",
  "./orderbook.js?v=26-20-runtime-hotfix",
...
self.addEventListener("fetch", (event) => {
  ...
  if (url.pathname.endsWith("/orderbook.js")) {
    const forcedUrl = new URL("./orderbook.js?v=26-20-runtime-hotfix", self.registration.scope);
