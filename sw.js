...
const FORCED = new Map([
  ...
  ["/orderbook.js", "./orderbook.js?v=26-79-agg-center-tape-scale-settings-v1"],
  ...
  ["/orderbook-flow-workspace.js", "./orderbook-flow-workspace.js?v=26-79-agg-center-tape-scale-settings-v1"],
...
const SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=26-79-agg-center-tape-scale-settings-v1",
  "./app.js?v=26-79-agg-center-tape-scale-settings-v1",
  ...
  "./orderbook.js?v=26-79-agg-center-tape-scale-settings-v1",
  ...
  "./orderbook-flow-workspace.js?v=26-79-agg-center-tape-scale-settings-v1",
  "./observability.js?v=render-scheduler-v1",
  "./pwa-reset.js",
  "./refresh.html",
  "./refresh.js?v=26-79-agg-center-tape-scale-settings-v1",
  "./reset-v26.html",
  "./reset.js?v=26-79-agg-center-tape-scale-settings-v1",
