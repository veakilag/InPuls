...
const RELEASE_ASSETS = Object.freeze([
  ...
  "./orderbook.js?v=26-110-low-latency-active-tape-v1",
  ...
  "./orderbook-worker.js?v=26-110-low-latency-active-tape-v1",
  ...
  "./orderbook-flow-workspace.js?v=26-110-low-latency-active-tape-v1",
