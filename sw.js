const CACHE = "inpuls-26-69-tape-stable-pixels-v1";
const BUILD = "26-69-tape-stable-pixels-v1";

const FORCED = new Map([
  ["/app.js", "./app.js?v=26-69-tape-stable-pixels-v1"],
  ["/orderbook.js", "./orderbook.js?v=26-69-tape-stable-pixels-v1"],
  ...
  ["/pattern-catalog.js", "./pattern-catalog.js?v=26-69-tape-stable-pixels-v1"],
  ...
  ["/orderbook-worker.js", "./orderbook-worker.js?v=26-69-tape-stable-pixels-v1"],
  ...
  ["/orderbook-flow-workspace.js", "./orderbook-flow-workspace.js?v=26-69-tape-stable-pixels-v1"],
...
const SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=26-69-tape-stable-pixels-v1",
  "./app.js?v=26-69-tape-stable-pixels-v1",
  "./chart.js?v=23",
  "./engine.js?v=26-65-structured-signal-collection-v1",
  "./orderbook.js?v=26-69-tape-stable-pixels-v1",
  ...
  "./pattern-catalog.js?v=26-69-tape-stable-pixels-v1",
  ...
  "./orderbook-worker.js?v=26-69-tape-stable-pixels-v1",
  ...
  "./orderbook-flow-workspace.js?v=26-69-tape-stable-pixels-v1",
  "./observability.js?v=render-scheduler-v1",
  "./pwa-reset.js",
  "./refresh.html",
  "./refresh.js?v=26-69-tape-stable-pixels-v1",
  "./reset-v26.html",
  "./reset.js?v=26-69-tape-stable-pixels-v1",
