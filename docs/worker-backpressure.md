...
- The long-run campaign is implemented separately in `raw-stability-lab.html`; its method and acceptance boundary are documented in [raw-stability-lab.md](./raw-stability-lab.md).
